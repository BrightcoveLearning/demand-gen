  ...
  var searchInterface = sajari.init({
      ...
      tabFilters: {defaultTab:"This Site",tabs:[{title:"This Site",filter:"domain='campaign.support.brightcove.com'"}, {title:"All Brightcove Documentation",filter:""}]}, // User selectable filters
